...
public class Greens1 {
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement click = driver.findElement(By.xpath("//div[@title='Software Testing']"));
	
		Actions b=new Actions(driver);
		b.moveToElement(click).perform();
				
		Thread.sleep(4000);
		WebElement click2 = driver.findElement(By.xpath("//span[text()='Selenium Certification Training']"));
		click2.click();
